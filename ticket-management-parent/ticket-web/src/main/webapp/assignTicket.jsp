...
<div class="main-panel">
    ...
    <div class="card">
	                    <div class="card-header" data-background-color="green">
	                        <h4 class="title">Assign Ticket to an Employee</h4>
	                        <p class="category">Enter an employee id who going to give an solution</p>
	                    </div>
	                        ...
	                        <div class="row">
    								 <form action="/tickets/assign_employee" method="GET" >
	                                        ...
	                                        <div class="col-md-11">
                                               ...
                                               <div class="col-md-11">
												<div class="form-group label-floating form-success">
													<label class="control-label"style="height: 100%;left: 10px">Employee Id</label>
