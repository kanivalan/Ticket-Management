...
<div class="main-panel">
    ...
    <div class="card">
	                    <div class="card-header" data-background-color="blue">
	                        <h4 class="title">Give solution to the user</h4>
	                        <p class="category">Give an appropriate solution to the user</p>
	                    </div>
    								 ...
    								 <form action="/tickets/ticket_solution" method="GET" >
	                                        ...
	                                        <div class="col-md-11">
	                                            <div class="form-group">
	                                                <label style="margin-right: 650px;">Solution</label>
													<div class="form-group label-floating form-info">
									    				<label class="control-label" style="margin-left:0px;">Enter appropriate solution for the user query(min 30 words)</label>
								    					<textarea class="form-control" rows="5" name="TicketSolution"></textarea>
		                        					</div>
	                                            </div>
	                                        </div>
	                                    </div>
		...
		<button type="submit" class="btn btn-danger">Assign Ticket</button></div>
	</form>
	${ERROR}
