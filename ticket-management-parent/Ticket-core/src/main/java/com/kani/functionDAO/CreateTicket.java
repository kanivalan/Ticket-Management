...
public class CreateTicket {
	...
	public void updateTicket(String emailId, String password, int issueId, String updateDescription)
		...
		if (loginDao.userLogin(emailId, password)) {
			...
			throw new PersistenceException("Ticket cant be update description because you closed your ticket,e");
		}
	}
	...
	public void assignTicketToEmployee(String emailId, String password, int issueId, int empId)
			throws PersistenceException {
		LoginDAO loginDao = new LoginDAO();
		try {
	...
	// update the solution status to resolved after employee will give a
	// solution to user
	...
	public List<Issue> findUserDetails(String emailId, String password) throws PersistenceException {
